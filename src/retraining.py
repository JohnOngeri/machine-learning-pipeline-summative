...
class RetrainingService:
    ...
    def __init__(self,
                 data_dir: str = r"C:\Users\HP\OneDrive\Desktop\machine learning pipeline summative\data",
                 models_dir: str = r"C:\Users\HP\OneDrive\Desktop\machine learning pipeline summative\models"):
        
        self.data_dir = data_dir
        self.models_dir = models_dir
        self.retrain_dir = os.path.join(self.data_dir, 'retrain')
    ...
    def retrain_model(self, include_original_data: bool = True,
        ...
        try:
            ...
            if include_original_data and os.path.exists(original_csv):
    ...
    def _log_retraining_event(self, training_history: Dict, evaluation_results: Dict, new_samples: int):
        ...
        log_file = os.path.join(self.data_dir, 'logs', 'retraining_log.txt')
